...
class FavouritesActivity:AppCompatActivity(){
 ...
 private fun cat(i:FavouriteItem){val p=PrefsManager.getProfiles(this).firstOrNull{it.id==i.profileId}?:PrefsManager.getActiveProfile(this)?:return;PrefsManager.setActiveProfile(this,p.id);when(i.categoryType){"MOVIES"->startActivity(Intent(this,VodActivity::class.java));"SERIES"->startActivity(Intent(this,SeriesActivity::class.java));"LIVE"->startActivity(Intent(this,HomeActivity::class.java).apply{addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);putExtra(HomeActivity.EXTRA_SECTION,"LIVE")})}}
